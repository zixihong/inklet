 ...
 */
export function segmentRegions(data, options = {}) {
    const { similarity = 0.15, minSize = 20, maxAspectRatio = Infinity, charAspectRatio = 1.8, backgroundThreshold = 250, backgroundDarkThreshold = 15, } = options;
    ...
    for (const cluster of clusters) {
        ...
        regionsOut.push({
            ...
            averageColor: hexFromRgb(Math.round(rSum / n), Math.round(gSum / n), Math.round(bSum / n)),
        });
    }
